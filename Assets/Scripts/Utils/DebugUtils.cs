...
public static class DebugUtils {
    ...
    /// <summary>
    /// Executes and visualizes a Physics2D.BoxCast
    /// Ref: https://forum.unity.com/threads/visualize-a-2d-boxcast-with-this-simple-wrapper-method.415356/
    /// </summary>
    public static RaycastHit2D BoxCast( Vector2 origen, Vector2 size, float angle, Vector2 direction, float distance, int mask ) {
        var hit = Physics2D.BoxCast(origen, size, angle, direction, distance, mask);
